...
everyone. By default, API endpoints in all scopes, except for `jobs` and
`introspection`, are accessible for everyone.
...
| `introspection` | [`/v1/introspection/data-sources`][ref-ref-introspection] and the endpoints under it | ❌ No |
...
[ref-ref-introspection]: /reference/core-data-apis/rest-api/reference#data-source-introspection
